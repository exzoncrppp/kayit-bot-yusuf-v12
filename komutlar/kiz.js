...
exports.run = async (client, message, args) => {
  ...
  await(message.guild.member(user).roles.add(client.ayar.kiz));
  await message.react(client.emoji("onay"))
  await message.channel.send(embed.setDescription(`${user}** kullanıcısına** ${message.guild.roles.cache.get(client.ayar.kiz)}** rolü verildi!**`))
